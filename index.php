            ...
            <tr>
                ...
                <td>
                 <!-- berpindah halaman ketika klik edit berdasarkan id -->
                    <a href="index.php?hal=edit&id=<?php echo $data['id_anggota']?>" class="btn btn-warning"> Edit</a> 
                   <!-- ketika klik tombol hapus -->
                    <a href="index.php?hal=hapus&id=<?php echo $data['id_anggota']?>" onclick="return confirm('Apakah yakin menghapus data ini?')" 
